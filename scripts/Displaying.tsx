...
export function PluginHeader(props: IPluginHeaderProps): JSX.Element {
    ...
    const bar: IHeaderCommandBarItem[] = [
        ...
        },
        {
            id: 'write-review',
            text: 'Write a review',
            href: 'https://marketplace.visualstudio.com/items?itemName=ommhoa.pull-requests-filtered&ssr=false#review-details',
            target: '_blank',
            important: false,
        },
        {
            ...
            href: 'https://github.com/ommhoa/Pull-Requests-Filtered/issues',
            target: '_blank',
            important: false,
        },
        {
